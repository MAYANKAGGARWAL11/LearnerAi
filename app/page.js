...
with our AI-powered interview prep</p>
        <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <a href="/dashboard" className="inline-flex justify-center items-center py-4 px-5 mt-5 text-base font-medium text-center text-white rounded-lg bg-primary hover:bg-primary focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                Get Started
...
<div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
      ...
      >
       <AtomIcon className='h-8 w-8'/>
        ...
        <h2 className="mt-4 text-xl font-bold text-black">Tell about your job description</h2>

        <p className="mt-1 text-sm text-gray-600">
          Give information about your interview role,tech stack of your interview and years of your experience needed.
        </p>
      </a>
      ...
      <Edit className='h-8 w-8'/>
        ...
        <h2 className="mt-4 text-xl font-bold text-black">Generate Your Questions </h2>

        <p className="mt-1 text-sm text-gray-600">
          Click on generate.Your questions get generated than answer the question with a experience of a real interview.
        </p>
      </a>
      ...
      <Share2 className='h-8 w-8' />
        ...
        <p className="mt-1 text-sm text-gray-600">
          Check your feedback and based on that try again.
        </p>
      </a>
